  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#F3F0EA] dark:bg-[#0A0A0C] p-6">
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        <h1 className="text-2xl font-extrabold text-[#0A0A0C] dark:text-[#F3F0EA] font-[family-name:var(--font-nunito)]">
          Waiting for partner...
        </h1>
        ...
        >
          <span className="text-3xl font-extrabold tracking-[0.3em] text-[#0A0A0C] dark:text-[#F3F0EA] font-[family-name:var(--font-nunito)]">
            {inviteCode}
          </span>
          {copied ? (
        ...
        {copied && (
          <p className="text-sm text-green-500 font-semibold font-[family-name:var(--font-nunito)]">
            Copied!
          </p>
        )}
        ...
        <div className="w-full mt-4">
          ...
          {session.couple?.members.map((member, i) => (
            ...
            >
              ...
              <span className="text-sm font-semibold text-[#0A0A0C] dark:text-[#F3F0EA] font-[family-name:var(--font-nunito)]">
                {member.name}
          ...
          {(session.couple?.members.length ?? 0) < 2 && (
            <div className="flex items-center gap-3 py-2">
              ...
              <span className="text-sm text-[#98989D] italic font-[family-name:var(--font-nunito)]">
